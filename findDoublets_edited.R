...
#' @param doubletDeconRhop rhop value to determine upper cutoff for correlation in the blacklist. Default value is 1
#' @param doubletDeconPMF whether using unique gene expression in doublet determination criteria or not. Default is True
#' @param doubletDeconNoCore number of cores to be used during rescue step. Default is -1
#' @param resFilename folder to save all results
#'
