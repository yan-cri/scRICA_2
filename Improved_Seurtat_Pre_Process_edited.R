...
#' 1. 'newExpressionFile': Seurat expression file in ICGS format (ICGS genes)
#' 2. 'newFullExpressionFile': Seurat expression file in ICGS format (all genes)
#' 3. 'newGroupsFile': Groups file ICGS format
##----------------------------------------------------------------------------------------
