...
#' meata2list() Function
#'
#' This function allows you to find and estimate doublets with DoubletDecon for the provide input 'cellrangerResList'
#' @param metadata list including full path to cellranger analysis results for different samples.
#' @keywords meata2list
#' @export
#' @examples meata2list()
#' @return input 'cellrangerResList' that equals to sample names in txt file
#'
##----------------------------------------------------------------------------------------
