## makeGMMptPlots(): used to generate pseudotime times based on GMM clustering          ##
## Developed by Yan Li, June, 2021
##--------------------------------------------------------------------------------------##
#' makeGMMptPlots() Function
#' @details
...
makeGMMptPlots <- function(pseudoRes, plotname = 'TEST') {
  ...
  save_plot(sprintf('%s_ptGMM_plots.pdf', plotname), p, base_height = 5, base_width = 10)
  ## ---
}
## -----------END-----------END-----------END-----------END-----------END-------------- ##
