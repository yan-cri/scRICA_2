...
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result1/', level = 2)
```
...
```
    ...
    ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/', level = 1)
```
...
```
    ...
    The option `expCondCheck` of `sample`, `expCond1`, or `expCond2` summarized the identified clusters cell numbers with respect to each sample defined in the metadata table column `sample`, experimental condition levels defined in the metadata table column `expCond1` or `expCond2` respectively. The summarized results are saved inside the directory 'results_wOrgClusterAnnotation' or 'results_wOrgClusterAnnotation' under the directory name of option `resDir`.
        ...
        ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/results_wOrgClusterAnnotation/expCond_expCond1_org')
```
...
```
    ...
    ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/results_wOrgClusterAnnotation2', level = 1)
```
...
```
    ...
    ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/results_wOrgClusterAnnotation3', level = 1)
```

    ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/results_wOrgClusterAnnotation4', level = 2)
```
...
```
    ...
    ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/results_wOrgClusterAnnotation5', level = 1)
```
...
```
    ...
    ```{r  echo = FALSE}
twee(path = '/Users/yanli/Desktop/scRIC_development/scRICA_test_result/results_wOrgClusterAnnotation6', level = 2)
```
